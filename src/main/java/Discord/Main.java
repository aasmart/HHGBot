...
public class Main extends ListenerAdapter implements EventListener {
     ...
     */
    public static boolean loadBot() throws IOException, LoginException, InterruptedException {
        // Load credentials
        ...
        jda = JDABuilder.createDefault(
                ...
                .setActivity(Activity.playing("The Guild"))
                .build();
        jda.awaitReady();
